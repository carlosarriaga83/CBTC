...
export class ParallaxService implements IService {
    ...
    getDataForLayout4 = (): any => {
        return {
            "headerTitle": "News",
            "headerImage": "assets/images/background/11.jpg",
            ...
            "items": [
                ...
                },
                {
                    "id": 4,
                    "title": "Steel",
                    "subtitle": "To minimise settlements of the tower it is founded on a 50m piled foundation. The steel structure – up until then unique in Germany – consists of a perimeter tube made of Vierendeel-trusses. The 400m2 office floor petals are supported on 13cm thick steel-composite slabs."
                }
            ]
        };
    }
